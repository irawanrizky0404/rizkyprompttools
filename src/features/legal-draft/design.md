# Legal Document Draft Builder - Design Specification
...
5 steps: Document Type, Parties, Clauses, Tone, Output
- Complete: green, Active: cyan glow, Inactive: gray

---

## 5. Layout

- Max content: 1152px, Card grid: 448px
